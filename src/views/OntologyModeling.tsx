...
{currentTemplateData.structure}
    ...
    <div className="flex-1 flex overflow-hidden relative bg-slate-50">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-5">
          <div>
            <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2">制造资源</div>
          ...
          <div>
            <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2">产品定义</div>
            <div className="space-y-1.5">
          ...
          <div>
            <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2">生产执行</div>
            <div className="space-y-1.5">
          ...
          <div>
            <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2">设备与维护</div>
            <div className="space-y-1.5">
          ...
          <div>
            <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-2">组织与人员</div>
            <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-sm border border-slate-200/60 flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 text-[11px] font-medium text-slate-500">
                  <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-sm bg-slate-1000"></div> 制造资源</span>
                  <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-sm bg-emerald-500"></div> 生产执行</span>
                  <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-sm bg-purple-500"></div> 产品定义</span>
                  <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-sm bg-rose-500"></div> 供应链/质量</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {relNodes.map((node) => {
            ...
            return (
              <div 
                ...
                className={cn(
                  "absolute -translate-x-1/2 -translate-y-1/2 border-2 p-2 rounded-sm flex flex-col items-center w-28 z-20 transition-shadow cursor-move select-none",
                  colorClass,
                  isDragging ? "ring-2 ring-slate-400 scale-105" : "hover:shadow-md hover:border-slate-400"
                )}
  ...
  const renderInstancesTab = () => (
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50">
          ...
          {instanceNodes.map(node => {
            return (
              <div 
                ...
                className={cn(
                  "absolute transform -translate-x-1/2 -translate-y-1/2 bg-white border-2 p-3 rounded-sm flex flex-col items-center w-36 z-10 cursor-move select-none transition-shadow",
      ...
      <div className="h-48 bg-white border-t border-slate-200 p-4 shrink-0 overflow-y-auto">
        <h4 className="text-xs font-bold text-slate-800 mb-3 flex items-center gap-2">
          <Sparkles size={14} className="text-slate-800" /> 联动价值 (Agent & MCP & Workflow)
        </h4>
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-slate-100/50 border border-slate-200 p-3 rounded-sm">
            <div className="text-[10px] font-bold text-slate-800 mb-1">全场景语义理解</div>
            <p className="text-[10px] text-slate-600">Agent 现在知道 "涂布机-01" 发生 "主轴卡死" 故障，触发了 "维修单"，并能顺藤摸瓜找到受影响的 "批次"、"工单" 乃至 "小鹏汽车订单"。</p>
          </div>
          <div className="bg-amber-50/50 border border-amber-100 p-3 rounded-sm">
            <div className="text-[10px] font-bold text-amber-800 mb-1">跨域影响评估 (Impact Analysis)</div>
            <p className="text-[10px] text-slate-600">当设备故障时，系统自动沿着图谱计算：维修需要消耗 "备件-涂布辊"，由 "张三" 负责，且会导致 "WO-20260318-01" 延期，直接影响 "小鹏汽车" 的交付。</p>
          </div>
          <div className="bg-emerald-50/50 border border-emerald-100 p-3 rounded-sm">
            ...
            <p className="text-[10px] text-slate-600">基于图谱，Agent 自动生成应对工作流：1. 锁定受影响的批次；2. 预警销售人员联系小鹏汽车；3. 自动向仓库发起备件领用申请。</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <header className="border-b border-slate-200">
        ...
        <div className="flex items-center gap-1 px-4 border-t border-slate-200">
          {[
            ...
            { id: 'relations', label: '关系定义', icon: GitMerge },
